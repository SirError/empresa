...
@Named
@Default
public class EnderecoService implements Serializable, TableService<Endereco>{
	...
	public Endereco get(int credenciadoId, int id, String token) {
        return client
          .target(getUri() + "credenciado/"+ credenciadoId +"/endereco")
    ...
    public Endereco save(int credenciadoId, Endereco p, String token) {
    	return client
    	          .target(getUri() + "credenciado/"+ credenciadoId +"/endereco")
    	          .request(MediaType.APPLICATION_JSON)
    	          .header("Authorization", "Bearer " + token)
    ...
    public Endereco update(int credenciadoId, Endereco p, String token) {
    	return client
    	          .target(getUri() + "credenciado/"+ credenciadoId +"/endereco/" + p.getId())
    	          .request(MediaType.APPLICATION_JSON)
    	          .header("Authorization", "Bearer " + token)
    ...
    public Response delete(int credenciadoId, int id, String token) {
    	  return client
    	          .target(getUri() + "credenciado/"+ credenciadoId +"/endereco/" + id)
    	          .request(MediaType.APPLICATION_JSON)
    	          .header("Authorization", "Bearer " + token)
